...
namespace modaui\Updater\Controllers;
...
use modaui\Updater\Facades\Updater;

class UpdaterController
{
    public function index(Request $request): View
    {
        return view('modaui-updater::index', [
            'permission' => true,
    ...
    public function backup(Request $request): Factory|Application|View|\Illuminate\View\View|RedirectResponse|\Illuminate\Contracts\Foundation\Application
    {
        ...
        if ($data['updated']) {
            return redirect()->route('updater.index')->with([
                'message' => 'modaui is already up to date.',
                'type'    => 'success',
            ]);
        }
    ...
    public function versionCheck(): JsonResponse
    {
        ...
        return response()->json([
            'message' => $versionCheck ? 'modaui is already up to date.' : 'modaui don\'t updated.',
            'updated' => $versionCheck,
        ]);
    }
