...
use modaui\Updater\Exceptions\InvalidURLException;
use modaui\Updater\Exceptions\ZipException;
...
trait HasUpdater
{
    public function downloadNewUpdater(): void
    {
        ...
        $updaterDownloadUrl = config('modaui-updater.updater_download_url');
