...
@section('container')
    <div class="mx-auto w-4/5">
        ...
        <p class="mb-20 text-[20px]">{{ __('Thanks for purchasing modaui! You can now install your product in seconds and unlock the moda of AI. Let’s get you started!') }}</p>
        <p class="mb-20 text-[20px]">
            {{ __('Need help?') }}
            <a
                    class="inline-flex items-center gap-1"
                    href="https://mdio.shop/"
                    target="_blank"
            >
                {{ __('See how it works') }}
                <svg
