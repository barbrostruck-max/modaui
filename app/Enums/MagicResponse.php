...
enum modaResponse: int implements Contracts\WithIntBackedEnum
{
    use EnumTo;
    ...
    public function exception(): void
    {
        ...
        if ($this->exceptionsAsJson()) {
            throw new modaResponseApiException($message, $this->statusCode());
        }
    ...
    public function runtimeException(): void
    {
        ...
        if ($this->exceptionsAsJson()) {
            throw new modaResponseApiRuntimeException($message, $this->statusCode());
        }
