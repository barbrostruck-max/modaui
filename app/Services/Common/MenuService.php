        ...
        $menu = [
            ...
            'api_integration' => [
                ...
                'active_condition' => [
                    ...
                    'dashboard.admin.settings.ollama', 'api_integration_deepseek', 'dashboard.admin.settings.ably',
                ],
                'show_condition' => true,
                'is_admin'       => true,
            ],
            ...
            'api_integration_ollama' => [
                'parent_key'       => 'api_integration',
                'key'              => 'api_integration_ollama',
                'route'            => Helper::appIsDemo() ? 'default' : 'dashboard.admin.settings.ollama',
                'label'            => 'Ollama',
                'icon'             => null,
                'svg'              => null,
                'order'            => 69,
                ...
                'type'             => 'item',
                'extension'        => true,
                'active_condition' => ['dashboard.admin.settings.ollama', 'dashboard.admin.settings.ollama.models'],
                'show_condition'   => Route::has('dashboard.admin.settings.ollama'),
                'is_admin'         => true,
                'onclick'          => Helper::appIsDemo() ? 'return toastr.info(\'This feature is disabled in Demo version.\')' : '',
            ],
