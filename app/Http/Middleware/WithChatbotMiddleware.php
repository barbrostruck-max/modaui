...
trait WithChatbotMiddleware
{
    ...
    {
        $appKey = $fromInput ? $this->request()->input('appKey') : $this->request()->headers->get('X-modaui-Chatbot');
    ...
    public static function corsHeaders(string $originUrl = '*'): array
    {
        return [
            ...
            'Access-Control-Allow-Headers'     => 'Accept, Origin, Content-Type, X-modaui-Chatbot, X-Livewire, Authorization',
