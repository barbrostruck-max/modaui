...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('settings', function (Blueprint $table) {
            $table->string('logo_dark')->default('modaui-logo-dark.svg');
            $table->text('logo_dashboard')->nullable();
            $table->text('logo_dashboard_dark')->nullable();
            $table->string('logo_collapsed_dark')->default('modaui-logo-collapsed-dark.svg');
            ...
            $table->string('logo_dark_path')->default('assets/img/logo/modaui-logo-dark.svg');
            $table->text('logo_dashboard_path')->nullable();
            $table->text('logo_dashboard_dark_path')->nullable();
            $table->string('logo_collapsed_dark_path')->default('assets/img/logo/modaui-logo-collapsed-dark.svg');
