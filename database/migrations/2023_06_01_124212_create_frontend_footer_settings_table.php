...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('frontend_footer_settings', function (Blueprint $table) {
            ...
            $table->string('hero_scroll_text')->default('Discover modaui');
            $table->string('hero_button')->default('Start Making Money');
            $table->string('hero_button_url')->nullable('https://mdio.shop/');
            ...
            $table->string('footer_button_url')->default('https://mdio.shop/');
