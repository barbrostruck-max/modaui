...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
    ...
    moda("dispatch", (el) => dispatch3.bind(dispatch3, el));
    moda("watch", (el, { evaluateLater: evaluateLater2, cleanup }) => (key, callback) => {
    ...
    moda("id", (el, { cleanup }) => (name, key = null) => {
...
import_alpinejs2.default.moda("wire", (el, { cleanup }) => {
  let component;
  return new Proxy({}, {
    get(target, property) {
      if (!component) {
...
function history2(Alpine23) {
  Alpine23.moda("queryString", (el, { interceptor }) => {
    let alias;
...
import_alpinejs7.default.moda("js", (el) => {
