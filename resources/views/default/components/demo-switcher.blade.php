        ...
        >
            ...
            <div class="container py-7">
                <div class="mb-9 lg:w-1/2">
                    ...
                    <p class="text-sm">
                        @lang('Customize the visual appearence of modaui with a single click and complement the design principles of your brand identity. ')
                    </p>
                </div>
                        ...
                        <div class="group relative">
                            ...
                            <a
								...
								@if(isset($theme['slug']) && in_array($theme['slug'], ['aichatpro', 'imagepro']))
									href="https://aichatpro.modaproject.ai/"
								@else
									href="https://{{ $theme['slug'] == 'default' ? 'modaui.liquid-themes.com' : $theme['slug'] . '.projecthub.ai' }}"
								@endif
                                target="_blank"
                            ></a>
                        </div>
