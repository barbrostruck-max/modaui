<script>
    ...
    function sendOpenaiGeneratorForm(ev) {
        ...
        document.getElementById("openai_generator_button").innerHTML = modaui_localize.please_wait;

        if (gpt_openai_generator_button) {
            gpt_openai_generator_button.disabled = true;
            gpt_openai_generator_button.innerHTML = modaui_localize.please_wait;
        }
