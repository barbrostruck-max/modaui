...
<div id="modaui-chatbot-widget" class="{{ $settings_two->chatbot_position ?: 'bottom-left' }}">
    <div class="modaui-chatbot-widget--chat active-message-list bg-white active">
        <div class="modaui-chatbot-widget--header border-b-amber-700">
            <div class="title">modaui Bot<br><span>Theme Support</span>
            </div>
        ...
        <div class="modaui-chatbot-widget--message-list">
            @foreach($userChats as $userChat)
                <div class="modaui-chatbot-widget--message-list--item" data-id="{{ $userChat->id }}">
                    <img src="{{ $chatbot->image ? '/uploads/'.$chatbot->image : '/assets/img/chat-default.jpg' }}" class="svg" alt="ChatBot">
                    <div class="modaui-chatbot-widget--message-list--item-title">
        ...
        <button type="button" class="btn modaui-btn start-new-chat">Start New Chat</button>
        <div class="modaui-chatbot-widget--messages"></div>
        <form action="">
    ...
    <div class="modaui-chatbot-widget--trigger loaded bg-white">
        <img src="http://wordpress.test/wp-content/plugins/modaui-wp/assets/img/logo.svg" class="svg"  alt="ChatBot">
    </div>
</div>