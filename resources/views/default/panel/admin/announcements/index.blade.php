        ...
        >
            ...
            >
                <div class="flex items-center justify-between gap-4">
                    <div class="w-9/12">
                        <h3 class="mb-3">
                            @lang(setting('announcement_title', 'Welcome to modaui!'))
                        </h3>
                        <p class="mb-4">
                    ...
                    @if (setting('announcement_image_dark'))
                        <img
                            ...
                            alt="@lang(setting('announcement_title', 'Welcome to modaui!'))"
                        >
                    @endif
                    <img
            ...
            <x-forms.input
                ...
                value="{{ setting('announcement_title', 'Welcome to modaui!') }}"
