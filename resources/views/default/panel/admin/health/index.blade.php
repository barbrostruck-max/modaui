							...
							<x-card class:body="flex items-start gap-3">
								...
								<div>
									...
									<dt class="mt-0 text-sm font-medium text-gray-600 dark:text-gray-400">
										...
										@else
											Cron Jobs are disabled on your server. Click <a class="text-blue-600" href="https://docs.modaproject.ai/how-to-configure-cron-jobs-on-cpanel/ " target="_blank">here</a> to learn how to enable Cron Jobs.
										@endif
