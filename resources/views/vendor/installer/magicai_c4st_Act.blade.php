@props([
    'site_name' => isset($site_name) ? $site_name : 'modaui',
...
>
    ...
    <div class="mb-6">
        <h2 class="mb-9 text-[36px] font-bold tracking-[-0.015em]">{{ __('License activation is not required') }}</h2>
        <p class="mb-4 text-[15px] leading-[1.53em] text-heading-foreground lg:mx-auto lg:w-2/3">
            {{ __('This installation does not require external activation. You may continue using the application without connecting to any external portal.') }}
        </p>
    </div>
</x-card>
